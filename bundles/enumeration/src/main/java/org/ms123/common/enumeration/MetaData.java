...
interface  MetaData {
	...
	public final String ENUMERATION_PATH = "enumerations/{0}";
	public final String ENUMERATIONS_PATH = "enumerations";
	public final String ENUMERATION_TYPE = "sw.enum";
	public final String ENUMERATIONS_TYPE = "sw.enums";
