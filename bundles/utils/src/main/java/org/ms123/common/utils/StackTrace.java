...
public final class StackTrace
	...
	public static final class Entry
		...
		public String toString(final String prefix) {
			...
			buff.append(className).append(".").append(methodName).append("(").append(sourceFileName);
	...
	/*	public int hashCode() {
		...
		public boolean equals(final Object obj) {
			...
			if (obj != null && obj.getClass() == getClass()) {
				...
				return
						entry.className.equals(className) && entry.methodName.equals(methodName) && entry.sourceFileName.equals(sourceFileName) && entry.lineNumber.equals(lineNumber);
			}
