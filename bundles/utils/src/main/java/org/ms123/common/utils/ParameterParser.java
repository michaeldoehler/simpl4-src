...
public class ParameterParser {
	...
	public List<Map> parse(final String str, String listDelim, char separator, char delim) {
		List<Map> ret = new ArrayList();
		String[] params = str.split( listDelim );
		for(int i=0; i < params.length;i++){
			ret.add(parse(params[i], separator,delim));
		}
		return ret;	
	}
	...
	public Map parse(final String str, char separator, char delim) {
		if (str == null) {
			return new HashMap();
		}
		return parse(str.toCharArray(), separator, delim);
	}
	 ...
	 * @return a map of name/value pairs
	 */
	public Map parse(final char[] chars, char separator, char delim) {
		if (chars == null) {
			return new HashMap();
		}
		return parse(chars, 0, chars.length, separator, delim );
	}
	 ...
	 * @return a map of name/value pairs
	 */
	public Map parse( final char[] chars, int offset, int length, char separator, char delim ) {
