...
public class AnchorMacroRenderer extends AbstractMacroRenderer{
	public AnchorMacroRenderer(Context ctx, WikiParameters params, String content){
		super(ctx,params,content);
	}
	public String render(){
		WikiParameter p = m_params.getParameter("id");
		return "<span id=\""+p.getValue()+"\"/>";
	}
}
