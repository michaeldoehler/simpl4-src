...
(function(window, document, undefined) {
  console.error("Responsive.loading");
  var factory = function($, DataTable) {
    ...
    Responsive.prototype = {_constructor:function() {
      var that = this;
      var dt = this.s.dt;
      console.error("Responsive.Constructor");
      ...
      var columns = this.s.dt.columns().eq(0).map(function(i) {
        ...
        return{className:className, includeIn:[], auto:false, control:false, never:className.match(/\bnever\b/) ? true : false}
      });
      ...
      var inserted = $("<div/>").css({width:1, height:1, overflow:"hidden"}).append(clonedTable).insertBefore(dt.table().node());
    ...
    Responsive.defaults = {breakpoints:Responsive.breakpoints, auto:true, details:{renderer:function(api, rowIdx) {
