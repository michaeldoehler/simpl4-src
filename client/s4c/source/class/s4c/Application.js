...
/**
 * This is the main application class of your custom application "s4c"
 *
 * @asset(s4c/*)
 */
qx.Class.define("s4c.Application",
{
  ...
  members :
  {
    ...
    main : function()
    {
      ...
      */
      ...
      var login = new s4c.page.Login();
      var overview = new s4c.page.Overview();
