...
qx.Class.define("ms123.datamapper.InputTree", {
	...
	members: {
		...
		setFormat:function(format){
			this._label.setValue("<div style='border-bottom:1px solid gray;padding:3px;'><b>"+this.tr("datamapper.input") + ":"+ format+"</b></div>");
		},
		getSide:function(){
