 ...
 */
qx.Class.define("ms123.widgets.CollapsablePanel", {
	extend: qx.ui.core.Widget,
	include: [
	qx.ui.core.MRemoteChildrenHandling, qx.ui.core.MRemoteLayoutHandling, qx.ui.core.MContentPadding],
	implement: [
	 ...
	 */
	construct: function (label, layout,icon) {
		this.base(arguments);
	...
	members: {
		...
		_applyIcon: function (value) {
			this.getChildControl("bar").setIcon(value);
		},
