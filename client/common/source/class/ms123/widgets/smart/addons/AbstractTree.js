 ...
 */
qx.Class.define("ms123.widgets.smart.addons.AbstractTree", {
		...
		_onKeyPress: function (evt) {
			...
			if (modifiers == 0) {
				...
				case "Left":
					...
					if ((node.type == qx.ui.treevirtual.MTreePrimitive.BRANCH) && !node.bHideOpenClose && node.bOpened) {
						// ... then close it
						dm.setState(node, {
							bOpened: !node.bOpened
						});
				...
				case "Right":
					...
					if ((node.type == qx.ui.treevirtual.MTreePrimitive.BRANCH) && !node.bHideOpenClose) {
