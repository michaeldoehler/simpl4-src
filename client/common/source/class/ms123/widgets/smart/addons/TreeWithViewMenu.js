...
qx.Class.define("ms123.widgets.smart.addons.TreeWithViewMenu", {
	...
	properties: { /** Whether to display view abbreviation in the header */
		showAbbreviations: {
			check: "Boolean",
			init: true,
	...
	members: {
		...
		_createViewButtonMenu: function (col, widget) {
			...
			for (var i = 0; i < viewSelectionData[col].length; i++) {
				...
				viewButton.addListener("execute", function (e) {
