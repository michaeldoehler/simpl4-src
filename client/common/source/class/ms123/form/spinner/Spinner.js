 ...
 * var s = new ms123.form.spinner.Spinner();
 * s.set({
 *   max: 3000,
 *   min: -3000
 * });
 ...
 */
qx.Class.define("ms123.form.spinner.Spinner", {
	extend: qx.ui.core.Widget,
	implement: [ qx.ui.form.IStringForm, qx.ui.form.IForm],
	include: [ qx.ui.form.MForm,qx.ui.core.MContentPadding],
...
/*
  ...
  */
	...
	members: { /** Saved last value in case invalid text is entered */
