...
//			tm.clearSorting();
		...
		onCellClick: function (e) {
			...
			if (this._booleanCols.indexOf(colnum) >= 0){
				...
				this.facade.raiseEvent({ type: ms123.processexplorer.Config.EVENT_PROCESSSTARTED });
				var pc = new ms123.processexplorer.ProcessController({appRoot:this.getApplicationRoot() });
				pc.start(map);
			}
		},
