...
qx.Mixin.define("ms123.ckeditor.toolbar.fontfamily.MAction", {
	construct: function () {
	...
	members: { /** Font style map */
		...
		_action: function (nickname, family) {
			...
			if (!this._fontStyles[nickname]) {
				...
				new CKEDITOR.style(ms123.ckeditor.toolbar.fontfamily.MAction.font_style, {
					family: family
				});
			}
