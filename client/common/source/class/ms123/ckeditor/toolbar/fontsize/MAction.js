...
qx.Mixin.define("ms123.ckeditor.toolbar.fontsize.MAction", {
	construct: function () {
	...
	members: { /** Font size style map */
		...
		_action: function (nickname, size) {
			...
			if (!this._fontSizeStyles[nickname]) {
				...
				new CKEDITOR.style(ms123.ckeditor.toolbar.fontsize.MAction.fontSize_style, {
					size: size
				});
			}
