...
qx.Class.define("ms123.ckeditor.toolbar.fontsize.Button", {
	extend: ms123.ckeditor.toolbar.AbstractToolbarEntry,
	include: ms123.ckeditor.toolbar.fontsize.MAction,
	...
	construct: function (_ckrte, fontSizes) {
		...
		if (!fontSizes) {
			...
			fontSizes = ms123.ckeditor.toolbar.fontsize.Button.fontSizes;
		}
