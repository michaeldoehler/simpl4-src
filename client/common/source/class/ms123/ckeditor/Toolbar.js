...
qx.Class.define("ms123.ckeditor.Toolbar", {
	extend: qx.ui.toolbar.ToolBar,

	/**
	 * Constructor for a Toolbar
	 *
	 * param ckrte {ms123.ckeditor.CkEditor}
	 ...
	 *   [
	 *     [
	 *       { button : ms123.ckeditor.toolbar.bold.Button },
	 *       { button : ms123.ckeditor.toolbar.italic.Button }
	 *     ],
	 *     [
	 *       { button : ms123.ckeditor.toolbar.fontcolor.Button, { minWidth : 50 } },
	 *       { button : ms123.ckeditor.toolbar.fontsize.Button },
	 *     ]
	 *   ]
	 * 
	...
	construct: function (_ckrte, toolbarConfig) {
		...
		if (!toolbarConfig) {
			...
			toolbarConfig = ms123.ckeditor.Toolbar.DefaultConfiguration;
		}
		...
		_ckrte.addListener("instanceReady", function (e) {
	...
	statics: {
		...
		DefaultConfiguration: [
			...
			{
				button: ms123.ckeditor.toolbar.underline.Button
			},
			{
				button: ms123.ckeditor.toolbar.strikethrough.Button
			},
			{
				button: ms123.ckeditor.toolbar.removeformat.Button
			}],
			[{
				button: ms123.ckeditor.toolbar.alignleft.Button
			},
			{
				button: ms123.ckeditor.toolbar.aligncenter.Button
			},
			{
				button: ms123.ckeditor.toolbar.alignright.Button
			},
			{
				button: ms123.ckeditor.toolbar.alignjustify.Button
			}],
			[{
				button: ms123.ckeditor.toolbar.fontfamily.Button
			},
			{
				button: ms123.ckeditor.toolbar.fontsize.Button
			},
			{
				button: ms123.ckeditor.toolbar.fontcolor.Button
			},
			{
				button: ms123.ckeditor.toolbar.backgroundcolor.Button
			}],
			[{
				button: ms123.ckeditor.toolbar.outdent.Button
			},
			{
				button: ms123.ckeditor.toolbar.indent.Button
			}],
			[{
				button: ms123.ckeditor.toolbar.insertimage.Button,
				command: "image"
			},
			{
				button: ms123.ckeditor.toolbar.inserttable.Button,
				command: "tableProperties"
			},
			{
				button: ms123.ckeditor.toolbar.insertlink.Button,
				command: "link"
			},
			{
				button: ms123.ckeditor.toolbar.inserthr.Button
			},
			{
				button: ms123.ckeditor.toolbar.editsource.Button
			}],
			[{
				button: ms123.ckeditor.toolbar.orderedlist.Button
			},
			{
				button: ms123.ckeditor.toolbar.unorderedlist.Button
			}],
			[{
				button: ms123.ckeditor.toolbar.undo.Button
			},
			{
				button: ms123.ckeditor.toolbar.redo.Button
			}]
		]
	},

	members: { /** Map of command names to buttons, for context menus and double clicks */
		...
		getCommand: function (commandName) {
			...
			return (cmdButton ? qx.lang.Function.bind(cmdButton._action, cmdButton) : null);
		}
	}
});
